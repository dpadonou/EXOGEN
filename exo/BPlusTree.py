...
class BPlusTree(object):
    ...
    def generateGraph(self, nomFichier):
        nomYml= nomFichier+".yml"
        graph_yml = open(nomYml, 'w')
        self.show_yaml(file=graph_yml)
        graph_yml.close()
        
        os.system('cmd /c "python ./btree.py ./"'+nomYml+'" | dot -Tsvg >"'+nomFichier+'".svg"')
